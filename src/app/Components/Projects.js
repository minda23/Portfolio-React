    ...
    return (
        <div id="projects" ref={scrollRef}>
            <div id='part_project'>
                ...
                <ProjectsCard imagePath="images/identify-card" linkSite="https://identify-card-minda.netlify.app/" linkSource="https://github.com/minda23/Moje-projekty/blob/main/identify-card.zip" />
            </div>
        </div>
